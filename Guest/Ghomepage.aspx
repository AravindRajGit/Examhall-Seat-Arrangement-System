<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ghomepage.aspx.cs" Inherits="Guest_Ghomepage" %>

<!DOCTYPE html>
<html lang="en">

<head>
  <title>GPTC &mdash; Exam Scheduler</title>
  <meta charset="utf-8">
...
<a href="Login.aspx" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users"></span>Login</a>
          </div>
        </div>
      </div>
    </div>
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="d-flex align-items-center">
          <div class="site-logo">
              <a href="Ghomepage.jsp" class="d-block">
              Exam Scheduler GPTC
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                    <a href="Ghomepage.aspx" class="nav-link text-left">Home</a>
                </li>
<!--                <li class="has-children">
                  <a href="about.html" class="nav-link text-left">Ab</a>
                  <ul class="dropdown">
                ...
                <li>
                    <a href="NewStudent.aspx" class="nav-link text-left">New Student</a>
                </li>
                <%--<li>
                    <a href="NewUser.jsp" class="nav-link text-left">New User</a>
                </li>
                <li>
                    <a href="Login.jsp" class="nav-link text-left">Signin</a>
                  </li>--%>
              </ul>                                                                                                                                                                                                                                                                                          </ul>
            </nav>
